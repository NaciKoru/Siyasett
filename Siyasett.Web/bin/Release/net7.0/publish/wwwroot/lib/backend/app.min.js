...
!(function (o) {
        ...
        o(".side-nav").length &&
            ((s = function (e, t, n, a) {
                ...
                setTimeout(function () {
                    ...
                    null != t &&
                        ((e = document.querySelector(".leftside-menu .simplebar-content-wrapper")),
                            (t = t.offsetTop - 300),
                            e &&
                            100 < t &&
                            ((a = 600),
    ...
    e(),
        ...
        t(),
        o(".topnav-menu").length &&
        (o(".topnav-menu li a").each(function () {
            var e = window.location.href.split(/[?#]/)[0];
            this.href == e &&
                (o(this).addClass("active"),
        ...
        o("#top-search").on("focus", function (e) {
            return e.preventDefault(), a.children(".dropdown-menu.show").removeClass("show"), o("#search-dropdown").addClass("d-block"), !1;
        }),
        ...
        ((i = {
            ...
            (s = { cancelClass: "btn-light", applyButtonClasses: "btn-success" }),
            o('[data-toggle="date-picker"]').each(function (e, t) {
                var n = o.extend({}, s, o(t).data());
                o(t).daterangepicker(n);
            })),
        jQuery().timepicker &&
        ((s = { showSeconds: !0, icons: { up: "mdi mdi-chevron-up", down: "mdi mdi-chevron-down" } }),
        ...
        jQuery().maxlength &&
        ((s = { warningClass: "badge bg-success", limitReachedClass: "badge bg-danger", separator: " out of ", preText: "You typed ", postText: " chars available.", placement: "bottom" }),
    ...
    return (
        _createClass(e, [
            ...
            },
            {
                ...
                value: function (e) {
                    (this.config.sidenav.color = e), this.html.setAttribute("data-sidenav-color", e), this.setSwitchFromConfig();
                },
            },
            {
            ...
            },
            {
                ...
                value: function (e) {
                    (this.config.theme = e), this.html.setAttribute("data-theme", e), this.setSwitchFromConfig();
                },
            },
            {
            ...
            },
            {
                ...
                value: function () {
                    var n = this,
                        e =
                            (document.querySelectorAll("input[name=data-sidenav-color]").forEach(function (t) {
                    ...
                    e &&
                        e.addEventListener("click", function () {
                            ...
                            "full" !== t ? ("condensed" === t ? n.changeLeftbarSize("condensed" == e ? "default" : e, !1) : n.changeLeftbarSize("condensed", !1)) : n.showBackdrop(), n.html.classList.toggle("sidebar-enable");
                        }),
            ...
            },
            {
                ...
                value: function () {
                    var t = document.createElement("div"),
                        n = ((t.classList = "offcanvas-backdrop fade show"), document.body.appendChild(t), (document.body.style.overflow = "hidden"), window.innerWidth, this);
                    t.addEventListener("click", function (e) {
                        n.html.classList.remove("sidebar-enable"), document.body.removeChild(t), (document.body.style.overflow = null);
                    });
                },
            },
            {
            ...
            },
            {
                ...
                value: function () {
                    ...
                    window.innerWidth <= 750
                        ...
                        : 750 <= window.innerWidth && window.innerWidth <= 1140
                            ? ("full" !== e.config.sidenav.size && ("sm-hover" === e.config.sidenav.size ? e.changeLeftbarSize("condensed") : e.changeLeftbarSize("condensed", !1)),
                                "boxed" === e.config.layout.mode && e.changeLayoutMode("fluid", !1))
            ...
            },
            {
                ...
                value: function () {
                    ...
                    var e,
                        ...
                        c = this.config;
                    c &&
                        ((e = document.querySelector("input[type=radio][name=data-layout][value=" + c.nav + "]")),
                        ...
                        (n = document.querySelector("input[type=radio][name=data-layout-mode][value=" + c.layout.mode + "]")),
                            ...
                            r && (r.checked = !0),
                            i && (i.checked = !0),
                            s && "true" === c.sidenav.user.toString() && (true));
                },
            },
            {
                key: "init",
                value: function () {
                    this.initConfig(),
                    this.initSwitchListener(), this.initWindowSize();
                },
            },
        ]),
        e
